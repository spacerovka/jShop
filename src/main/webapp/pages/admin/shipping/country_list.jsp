...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
                    ...
                    <div class="col-lg-8">
                    <a href="${pageContext.request.contextPath}${URL_PREFIX}country/add"><button type="button" class="btn btn-primary">Add new country</button></a>
                        <h2>List of categories</h2>
                        <div class="table-responsive" id="table">
                       		<%@include file="_country_table.jsp"%>
	...
	function pageButtonClick(targetPage)
	{
		...
		$.ajax ({ 
			url: '${pageContext.request.contextPath}${URL_PREFIX}findCountry', 
			type: "POST", 						
